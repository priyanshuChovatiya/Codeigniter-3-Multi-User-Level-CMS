                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-bold">Tunkey</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <div class="card-body mt-2">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?= base_url("login/verify") ?>" method="POST">
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" class="form-control" maxlength="10" required minlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" id="mobile" name="mobile" placeholder="Enter Your Mobile No" autofocus />
